...
#define RANDOMLIB_EXACTEXPONENTIAL_HPP \
  "$Id: 1850768a6919546b2afa1cd5e017da0704fe612f $"
...
\endverbatim
     ...
     * of bits in the result).  If we code the result in mixed unary-binary
     * notation (integer is given in unary, followed by "0" as a separator,
     * followed by the fraction in binary), then the mean balance is 5.680.
     *
