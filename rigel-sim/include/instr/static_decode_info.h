...
class StaticDecodeInfo {
  ...
  public:
    ...
    { };
		...
		StaticDecodeInfo(uint32_t pc, uint32_t raw) {
			decode(pc, raw);
		}
    ...
    uint32_t optype() const; /// autogenerated
    uint32_t opcode() const; /// autogenerated 
    // FIXME autogenerate these
    uint32_t reg_d() const { return 0x0000001F & (raw_instr_bits >> 23);}
    uint32_t reg_t() const { return 0x0000001F & (raw_instr_bits >> 18);}
    uint32_t reg_s() const { return 0x0000001F & (raw_instr_bits >> 13);}
    uint32_t imm5()  const { return 0x0000001F & (raw_instr_bits >> 13);}
    uint32_t imm16() const { return 0x0000FFFF & (raw_instr_bits >> 0 );}
    uint32_t imm26() const { return 0x03FFFFFF & (raw_instr_bits >> 0 );}

    uint32_t simm16() const { return int32_t(int16_t(imm16()));}

    bool valid() const  { return valid_; }
    instr_t type() const { return type_; }
